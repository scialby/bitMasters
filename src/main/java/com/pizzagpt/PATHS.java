...
public final class PATHS {
    ...
    public final static String IMAGES = RESOURCES + "/com.pizzagpt/images/";
    ...
    public final static String SORTINO_EX ="/com.pizzagpt/scenes/sortino/Exercise.fxml"; // Percorso per la vista dell'esercizio
    public final static String CORRECTVIEW ="/com.pizzagpt/scenes/sortino/Correct.fxml"; // Percorso per la vista dell'esercizio
    public final static String WRONGVIEW ="/com.pizzagpt/scenes/sortino/Wrong.fxml"; // Percorso per la vista dell'esercizio
